...
const Tickets = () => {
    ...
    useEffect(() => {
        ...
        if (projectFilter.title == "All") {
            ...
            setFilteredTickets(
                tickets.filter(
                    (ticket) => ticket.project.id == projectFilter.id
                )
            );
        }
            ...
            <Layout>
                <div className="flex flex-col gap-4 px-3 md:flex-row md:justify-between">
                    ...
                    <Link href="/tickets/new">
                        <a className="">
                            <div className="h-6 w-full rounded bg-white text-dodger-blue shadow-sm transition-all duration-200 hover:text-moody-blue hover:shadow-lg md:w-6">
                                <Plus className="mx-auto h-6 w-6" />
                            </div>
                        </a>
                    </Link>
                </div>
                <div className="mr-2.5 bg-white py-6 text-center font-bold text-scorpion shadow-sm">
                    {error}
                </div>
            </Layout>
        );
